...
with col1:
    ...
    fonte_agenzia_entrate_circ = st.checkbox("Circolari Agenzia delle Entrate", value=True)
    fonte_agenzia_entrate_interpello = st.checkbox("Risposte Interpello AdE", value=True)
